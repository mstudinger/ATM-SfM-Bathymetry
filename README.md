...
* **Tutorial:** ✨ [Calculate the azimuth of true north in projected coordinates and plot it on a map](https://github.com/mstudinger/ATM-SfM-Bathymetry/blob/main/Jupyter/azimuth_of_true_north_in_xy_coords_and_map_plots.ipynb): Notebook demonstrating calculation of the azimuth of true north for a given location and map projection. It also provides helper functions for plotting north arrows and scale bars on projected maps in selectable positions on the map.  
***
