...
* **Tutorial:** [Sample raster data along a profile](https://github.com/mstudinger/ATM-SfM-Bathymetry/blob/main/Jupyter/create_profile_sample_raster_tutorial.ipynb): Notebook demonstrates how to create a profile from start and end coordinates and sample raster values along the profile.   
***
